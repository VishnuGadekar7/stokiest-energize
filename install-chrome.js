...
async function main() {
  ...
  // 1. Clean up corrupted folders created by npx puppeteer silent failures
  ...
  try {
    // 2. We MUST install the exact version Puppeteer expects: 148.0.7778.97
    const buildId = "148.0.7778.97";
    
    // 3. Install it using the programmatic API
    console.log(`[chrome-install] Installing exact Chrome build ${buildId}...`);
